...
{
    public class InventariosEsqueletoController : Controller
    {
        private readonly AppDbContext _context;

        public InventariosEsqueletoController(AppDbContext context)
        {
            _context = context;
        }

        // GET: InventariosEsqueleto
        ...
        // GET: InventariosEsqueleto/Details/5
        ...
        // GET: InventariosEsqueleto/Create
        public IActionResult Create()
        {
            ViewData["InventarioEsqueletoId"] = new SelectList(_context.Relatorios, "RelatorioId", "Codigo");
            return View();
        }

        // POST: InventariosEsqueleto/Create
        ...
        public async Task<IActionResult> Create([Bind("InventarioEsqueletoId,RelatorioId,FotoEsqueleto,Observacoes")] InventarioEsqueleto inventarioEsqueleto)
        {
            ...
            ViewData["InventarioEsqueletoId"] = new SelectList(_context.Relatorios, "RelatorioId", "Codigo", inventarioEsqueleto.InventarioEsqueletoId);
            return View(inventarioEsqueleto);
        }

        // GET: InventariosEsqueleto/Edit/5
        ...
        // POST: InventariosEsqueleto/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: InventariosEsqueleto/Delete/5
        ...
        // POST: InventariosEsqueleto/Delete/5
        ...
        {
          return _context.InventariosEsqueletos.Any(e => e.InventarioEsqueletoId == id);
        }
    }
}
